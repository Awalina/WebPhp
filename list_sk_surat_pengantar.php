<?php
	...
	global $wpdb;
	$tableName="fix_vw_t_surat_pengantar";		
	$targetpage = "?page=surat_pengantar"; 	
	echo get_permalink();
	$limit = 20; 
...
echo '<meta http-equiv="refresh" content="0; url=?page=surat_pengantar&paging='.$paging.' ">';
}
...
<?php
	...
	{
		include"form_edit/sk_surat_pengantar.php";
	}
	?>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
							...
							{
								$url="<a href='?page=surat_pengantar&id_laporan_setuju=".$pengaduan->id."&status_id_next=".$pengaduan->c_status_next."&id_warga=".$pengaduan->id_warga."&page_form=".$pengaduan->c_surat."'>Lanjut</a>";
							...
							foreach($list_cek_if_print as $cek_if_print)
							{
								if($pengaduan->status_id >= $cek_if_print->value)
								{
									...
									$url_edit=" | <a href='?page=surat_pengantar&id_laporan_sunting=".$pengaduan->id."'>Sunting</a>";
								}
							}
							}
