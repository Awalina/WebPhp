...
function my_plugin_menu() {
	...
	add_menu_page('Adminstrasi', 'Administrasi', 'manage_options', 'top-level', 'my_plugin_options');
		...
		add_submenu_page('top-level', 'SK - Catatan Kepolisian', 'SK - Catatan Kepolisian', 'manage_options', 'sk_ck', 'sk_ck');
				...
				add_submenu_page('top-level', 'SK - Keterangan Domisili Perusahaan', 'SK - Keterangan Domisili Perusahaan', 'manage_options', 'sk_keterangan_domisili_perusahaan', 'sk_keterangan_domisili_perusahaan');
...
echo '<p><a href="?page=sk_keterangan_domisili_perusahaan">SK - Keterangan Domisili Perusahaan</p></a>';
...
function sk_keterangan_domisili_perusahaan() {
	...
	echo '<h2>Daftar Pendaftar SK - Keterangan Domisili Perusahaan</h2>';

	include 'list_sk_keterangan_domisili_perusahaan.php';
