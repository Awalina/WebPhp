...
{$checked_gender="";}
?>
<input type="radio" name="j_kelamin_srt_ket" id="j_kelamin_srt_ket" value="<?php echo $gender->c_jenis_kelamin;?>";
 <?php echo $checked_gender;?>/>
...
<input type="text" name="c_no_rt_rw" id="c_no_rt_rw"  size="55" value="<?php echo $sel_get_sunting->id_warga;?>"/>
                ...
                <tr>
                  ...
                  <td><label></label>
                      <label>
                      <input name="letak" type="text" id="letak" size="55" value="<?php echo $sel_get_sunting->c_lokasi_lahan;?>"/>
                    </label></td>
                </tr>
