                ...
                <tbody>
                    <tr>
                        ...
                        <td>
							...
							{
								$url="<a href='?page=sk_keterangan_domisili_perusahaan&id_laporan_setuju=".$pengaduan->id."&status_id_next=".$pengaduan->c_status_next."&id_warga=".$pengaduan->id_warga."&page_form=".$pengaduan->c_surat."'>Lanjut</a>";
                            ...
                            <td>" . $pengaduan->c_jenis_kelamin . "</td>
                            <td>" . $status . "  " . "</td>
