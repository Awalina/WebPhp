...
?>
	...
	<thead><TR><th>#</th><TH>ID</TH><TH>Nama</TH><TH>No. KTP</TH><TH>No. Telepon</TH><TH>Isi Pengaduan</TH><TH>
Status</TH><TH>Proses</TH></TR></thead><?php
	...
	foreach($listpengaduan as $pengaduan){ 
	 ?>
		<tbody>
        <TR>
        <TD><?php echo"<input type=checkbox name=cek[] value=". $pengaduan->id_laporan ." id=$no>"; $no++; ?></TD>
